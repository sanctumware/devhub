  ...
  <div class="page-content row">
 	<div class="page-content-wrapper m-t">
 		...
 		<div class="ajaxLoading"></div>
			...
			<div class="sbox-title"> <h3><i class="icon-database text-danger"></i> Database Tables  <small> Manage Database Tables </small> </h3>
			<span class="pull-right">	
				<a href="{{ URL::TO('sximo/tables/tableconfig/')}}" class="btn btn-xs btn-white linkConfig"><i class="fa fa-plus"></i> New Table </a>
				<a href="{{ URL::TO('sximo/tables/mysqleditor/')}}" class="btn btn-xs btn-white linkConfig"><i class="fa fa-pencil"></i> MySQL Editor </a>
			</span>	
			</div>
