...
<div class="sbox">
    <div class="sbox-title">   <h3> Sximo 5.1.6 <small> {{ $pageNote }} </small></h3> </div>
  <div class="sbox-content" style="font-size:12px;">


<h3> Next Release candidate Version 5.1.7  - Planned </h3>
    <ol>  
      <li> Plugins / Widget Manager </li>
