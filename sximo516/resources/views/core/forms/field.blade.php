...
<?php $formID = $row['formID'];?>
 {!! Form::open(array('url'=>'core/forms/field/'.$row['formID'], 'id'=>'formField')) !!}
...
<div class="form-vertical row">
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Label / Title </label>
		<input type="text" class="form-control" name="label" value="<?php echo $f['label'];?>" />
  </div> 
		
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Field </label>
		<input type="text" class="form-control" name="field" value="<?php echo $f['field'];?>" @if($f['field'] !='') readonly="1" @endif />
  </div> 
